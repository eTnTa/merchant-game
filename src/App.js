...
import placeData from './data/place\_special\_items.json';
import './App.css';

function App() {
const INITIAL\_MONEY = 3000;
...
const \[money, setMoney] = useState(() => Number(localStorage.getItem('playerMoney')) || INITIAL\_MONEY);
...
setMoney(INITIAL\_MONEY);
alert("所持金をリセットしました！（3000G）");
};

return (
\<div className="App" style={{ fontFamily: 'sans-serif', padding: '20px' }}> <h1>行商ボードゲーム {isBlackMarket ? '闇市場' : '売買画面'}</h1> <h2>
